 ...
 */
@interface LLFiveVisibleMapRegionDelegate : NSObject
...
@interface LLFiveViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LLFiveVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
@implementation LLFiveViewController
...
- (void)viewDidLoad {
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL-5.pdf" withExtension:@"pdf" subdirectory:@"Floorplans"];
    ...
    [[LLFiveVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LLFiveViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LLFiveViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LLFiveVisibleMapRegionDelegate ()
...
@implementation LLFiveVisibleMapRegionDelegate
