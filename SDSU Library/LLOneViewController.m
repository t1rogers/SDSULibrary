 ...
 */
@interface LLOneVisibleMapRegionDelegate : NSObject
...
@interface LLOneViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LLOneVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
- (void)viewDidLoad {
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL-1" withExtension:@"pdf" subdirectory:@"/Maps/Floorplans"];
    ...
    [[LLOneVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LLOneViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LLOneViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LLOneVisibleMapRegionDelegate ()
...
@implementation LLOneVisibleMapRegionDelegate
