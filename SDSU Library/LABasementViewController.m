...
#import "LABasementViewController.h"
 ...
 */
@interface LABasementVisibleMapRegionDelegate : NSObject
...
@interface LABasementViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LABasementVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
@implementation LABasementViewController
...
- (void)viewDidLoad {
    ...
    AAPLGeoAnchor anchor1 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775634, -117.072845),
        .PDFPoint = CGPointMake(132, 96.67)
    };
    
    AAPLGeoAnchor anchor2 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.774183, -117.070426),
        .PDFPoint = CGPointMake(132, 42.6)
    };
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LA_CROPPED-BASEMENT" withExtension:@"pdf" subdirectory:@"Floorplans"];
    ...
    [[LABasementVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LABasementViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LABasementViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LABasementVisibleMapRegionDelegate ()
...
@implementation LABasementVisibleMapRegionDelegate
