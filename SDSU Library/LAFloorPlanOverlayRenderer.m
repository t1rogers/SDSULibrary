 ...
 */
+ (void)drawDiagnosticVisuals:(CGContextRef)context floorplan:(LAFloorplanOverlay *)floorplanOverlay;

@end

@implementation LAFloorplanOverlayRenderer

- (void)drawMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale inContext:(CGContextRef)context {
    NSAssert([self.overlay isKindOfClass:[LAFloorplanOverlay class]], @"Wrong overlay type.");
    
    LAFloorplanOverlay *floorplanOverlay = self.overlay;
