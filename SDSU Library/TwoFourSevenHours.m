...
@implementation TwoFourSevenHours
...
- (void)viewDidLoad
{
    ...
    xmlParser = nil;
    xmlParser = [[HoursXMLParser alloc] loadXMLByURL:@"https://library.sdsu.edu/guides/rss/hours_247.rss"];
...

{
	...
	CGRect hoursFrame = CGRectMake(32, 25, 250, 25);
