...
- (void)viewDidLoad {
    ...
    AAPLGeoAnchor anchor1 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775280, -117.071289),
        .PDFPoint = CGPointMake(396, 290)
    };
    
    AAPLGeoAnchor anchor2 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775137, -117.071290),
        .PDFPoint = CGPointMake(396, 128)
    };
    ...
    /*
        ...
        phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL_CROPPED" withExtension:@"pdf" subdirectory:@"Floorplans"];
