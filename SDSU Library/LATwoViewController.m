 ...
 */
@interface LATwoVisibleMapRegionDelegate : NSObject
...
@interface LATwoViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LATwoVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
@implementation LATwoViewController
...
- (void)viewDidLoad {
    ...
    AAPLGeoAnchor anchor1 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775260, -117.071299),
        .PDFPoint = CGPointMake(132, 96.67)
    };
    
    AAPLGeoAnchor anchor2 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775117, -117.071300),
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LA_CROPPED-2" withExtension:@"pdf" subdirectory:@"Floorplans"];
    ...
    [[LATwoVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LATwoViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LATwoViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LATwoVisibleMapRegionDelegate ()
...
@implementation LATwoVisibleMapRegionDelegate
