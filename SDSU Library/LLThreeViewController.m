 ...
 */
@interface LLThreeVisibleMapRegionDelegate : NSObject
...
@interface LLThreeViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LLThreeVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
@implementation LLThreeViewController
...
- (void)viewDidLoad {
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL-3" withExtension:@"pdf" subdirectory:@"/MapsFloorplans"];
    ...
    [[LLThreeVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LLThreeViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LLThreeViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LLThreeVisibleMapRegionDelegate ()
...
@implementation LLThreeVisibleMapRegionDelegate
