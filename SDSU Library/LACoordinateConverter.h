//
//  LACoordinateConverter.h
//  Footprint
//
//  Created by Admin jrogers on 2/12/16.
 ...
 */
typedef struct {
    LAGeoAnchor fromAnchor;
    LAGeoAnchor toAnchor;
} LAGeoAnchorPair;
 ...
 */
@interface LACoordinateConverter : NSObject
...
@property (nonatomic, readonly) LAGeoAnchorPair anchors;
