 ...
 */
#define kImageFilename @"1la_2013-08.jpg" // 7033x10110 image, 271 MB uncompressed
...
@implementation OneLAViewController
...
-(void)downsize:(id)arg {
    ...
    destContext = CGBitmapContextCreate( destBitmapData, destResolution.width, destResolution.height, 8, bytesPerRow, colorSpace, (CGBitmapInfo)kCGImageAlphaPremultipliedLast );
