...
- (void)viewDidLoad
{
    ...
    xmlParser = nil;
    xmlParser = [[HoursXMLParser alloc] loadXMLByURL:@"https://library.sdsu.edu/guides/rss/hours_reference.rss"];
...

{
	...
	CGRect hoursFrame = CGRectMake(32, 25, 170, 25);
