...
- (void)viewDidLoad {
    ...
    self.title = @"Special Collections";
     ...
     */
    static NSString *feedURLString = @"http://libpac.sdsu.edu/feeds/spcol.xml";
...
/**
 * When the user taps a row in the table, display the OPAC page that displays details of the earthquake they selected.
 */
