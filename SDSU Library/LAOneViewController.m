...
#import "LAOneViewController.h"
#import "LACoordinateConverter.h"
#import "LAFloorplanOverlay.h"
#import "LAFloorplanOverlayRenderer.h"
 ...
 */
@interface LAOneVisibleMapRegionDelegate : NSObject
...
@interface LAOneViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LAOneVisibleMapRegionDelegate *visibleMapRegionDelegate;

/// Store the data about our floorplan here.
@property (nonatomic, strong) LAFloorplanOverlay *floorplan0;
 ...
 */
+ (nonnull NSArray<id<MKAnnotation>> *)createDebuggingAnnotationsForMapView:(MKMapView *)mapView aboutFloorplan:(LAFloorplanOverlay *)floorplan;
 ...
 */
+ (nonnull NSArray<id<MKOverlay>> *)createDebuggingOverlaysForMapView:(MKMapView *)mapView aboutFloorplan:(LAFloorplanOverlay *)floorplan;

@end

#pragma mark LLThreeViewController

@implementation LAOneViewController
...
- (void)viewDidLoad {
    ...
    AAPLGeoAnchor anchor1 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.775264, -117.070447),
        .PDFPoint = CGPointMake(132, 96.6)
    };
    
    AAPLGeoAnchor anchor2 = {
        .latitudeLongitude = CLLocationCoordinate2DMake(32.774899, -117.070447),
        .PDFPoint = CGPointMake(132, 42)
    };
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LA_CROPPED-1" withExtension:@"pdf" subdirectory:@"Floorplans"];
    
    self.floorplan0 = [[LAFloorplanOverlay alloc] initWithFloorplanURL:pdfUrl PDFBox:kCGPDFTrimBox anchors:anchorPair forFloorAtLevel:0];
    
    self.visibleMapRegionDelegate =
    [[LAOneVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LAOneViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LAOneViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
- (MKOverlayRenderer *)mapView:(MKMapView *)mapView rendererForOverlay:(id<MKOverlay>)overlay {
    ...
    if ([overlay isKindOfClass:[LAFloorplanOverlay class]]) {
        LAFloorplanOverlayRenderer *renderer = [[LAFloorplanOverlayRenderer alloc] initWithOverlay:overlay];
        return renderer;
    }
...
@interface LAOneVisibleMapRegionDelegate ()
...
@implementation LAOneVisibleMapRegionDelegate
