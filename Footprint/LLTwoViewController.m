 ...
 */
@interface LLTwoVisibleMapRegionDelegate : NSObject
...
@interface LLTwoViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LLTwoVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
#pragma mark LLTwoViewController
...
- (void)viewDidLoad {
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL_CROPPED-2" withExtension:@"pdf" subdirectory:@"Floorplans"];
    ...
    [[LLTwoVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LLTwoViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LLTwoViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LLTwoVisibleMapRegionDelegate ()
...
@implementation LLTwoVisibleMapRegionDelegate
