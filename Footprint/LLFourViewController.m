 ...
 */
@interface LLFourVisibleMapRegionDelegate : NSObject
...
@interface LLFourViewController () <MKMapViewDelegate>
...
@property (nonatomic, strong) LLFourVisibleMapRegionDelegate *visibleMapRegionDelegate;
...
- (void)viewDidLoad {
    ...
    /*
     ...
     phases.
     */
    NSURL *pdfUrl = [[NSBundle mainBundle] URLForResource:@"LL-4" withExtension:@"pdf" subdirectory:@"Floorplans"];
    ...
    [[LLFourVisibleMapRegionDelegate alloc]
    ...
    self.debuggingOverlays = [LLFourViewController createDebuggingOverlaysForMapView:self.mapView aboutFloorplan:self.floorplan0];
    self.debuggingAnnotations = [LLFourViewController createDebuggingAnnotationsForMapView:self.mapView aboutFloorplan:self.floorplan0];
#endif
...
@interface LLFourVisibleMapRegionDelegate ()
...
@implementation LLFourVisibleMapRegionDelegate
